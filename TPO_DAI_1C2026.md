Desarrollo de Aplicaciones I Primer Cuatrimestre 2026
...
La empresa solicito un desarrollo para dispositivos móviles que les permita a los usuarios participar de forma on-line en las subastas que realizala empresa en forma presencial, como así también indicar que posee algún artículo que deseen incluir en futuras subastas.
...
El ***postor*** esuna persona que participa enunasubasta ofreciendodineropara intentar comprar el objeto que se está subastando.
...
Enelcasode lassubastasendólareslas mismasdebe sercanceladas endichamoneda (ya se por transferencia o por una tarjeta internacional)
...
Se debe garantizar que los pujes de los usuarios están registrados correctamente, por loque cuandounusuariohaceunpuje la aplicaciónnodebe permitirotrohastahaberrecibido la confirmación por parte del sistema que
la transacción fue realizada con éxito e informado al resto de los usuarios.
...
Si la empresa está interesada en los mismos, elusuario deberá enviarlos a la dirección que le indiquen para proceder a la inspección de estos. Se debe aclarar que el usuario esta de acuerdo que en caso de no aceptar el bien enviado la empresa lo devolverá con cargo al usuario.
...
Si nadie puja por un artículo,la empresa compra el mismopor el valor base al finalizar la subasta.
...
• El plano de despliegue de estos wireframes [(<u>Figma</u>)](https://www.figma.com/).
...
• Descripción de los endpoints del API Rest diseñado con sus correspondientes parámetros, retornos, códigos de retorno (200, 404, etc.), puede utilizar [<u>Swagger</u>.](https://swagger.io/) [<u>https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml</u>](https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml)
